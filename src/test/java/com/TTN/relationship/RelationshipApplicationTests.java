...
class RelationshipApplicationTests {
	...
	@Autowired
	EntityManager entityManager;//inbuild
	...
	public void testCreateSubjectList() {
		...
		author.setId(6);
		author.setAuthorname("Sofi lama");
		...
		author.getSubjectList().add("Maths");
		author.getSubjectList().add("Science");
		author.getSubjectList().add("Social");
